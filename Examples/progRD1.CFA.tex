...
\draw [myarrow]  (vert6)  -- node[sloped,above]{$!(y>0)$}  (vert8);
\draw [myarrow]  (vert4) |-  node[sloped, near start,above]{y:=y-1} (vert7);
...
\draw [myarrow]  (vert3)  --  node[sloped, near start,above]{y:=0} (vert2);
