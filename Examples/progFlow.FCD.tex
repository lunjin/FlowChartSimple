...
\matrix[row sep =5mm,column sep=5mm]{
 &\node(vert1)[start]{}; &\\
 &\node(vert8)[decision]{$x>y*2$}; &\\
\node(vert7)[process]{w:=x*2}; &\node(vert5)[decision]{$y>x*2$}; &\\
\node(vert6)[process]{z:=y*2+1}; &\node(vert4)[process]{w:=x+1}; &\node(vert3)[process]{z:=y*2+1};\\
 &\node(vert2)[stop]{}; &\\
};

\draw [myarrow]  (vert7.south) -- (vert6.north);
\draw [myarrow]  (vert5.south)  -- node[sloped,above]{yes} (vert4.north);
\draw [myarrow]  (vert5.south) -| node[sloped,above, near start]{no} (vert3.north);
\draw [myarrow]  (vert8.south)  -| node[sloped,above, near start]{yes} (vert7.north);
\draw [myarrow]  (vert8.south) -- node[sloped,above]{no} (vert5.north);
\draw [myarrow]  (vert1.south) -- (vert8.north);
\draw [myarrow]  (vert6.south) |- (vert2.north);
\draw [myarrow]  (vert4.south) -- (vert2.north);
