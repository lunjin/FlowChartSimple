...
\matrix[row sep =5mm,column sep=5mm]{
 &\node(vert1)[start]{}; &\\
 &\node(vert9)[decision]{$x>y*2$}; &\\
\node(vert8)[process]{y:=x*2}; &\node(vert6)[decision]{$y>x*2$}; &\\
\node(vert7)[process]{x:=y*2+1}; &\node(vert5)[process]{y:=x*2+1}; &\node(vert4)[process]{x:=y*2+1};\\
 &\node(vert3)[process]{z:=x*2+y*2}; &\\
 &\node(vert2)[stop]{}; &\\
};

\draw [myarrow]  (vert8.south) -- (vert7.north);
\draw [myarrow]  (vert6.south)  -- node[sloped,above]{yes} (vert5.north);
\draw [myarrow]  (vert6.south) -| node[sloped,above, near start]{no} (vert4.north);
\draw [myarrow]  (vert9.south)  -| node[sloped,above, near start]{yes} (vert8.north);
\draw [myarrow]  (vert9.south) -- node[sloped,above]{no} (vert6.north);
\draw [myarrow]  (vert7.south) |- (vert3.north);
\draw [myarrow]  (vert5.south) -- (vert3.north);
