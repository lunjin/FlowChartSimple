...
\draw [myarrow]  (vert9)  --  node[sloped, near start,above]{x:=6} (vert8);
\draw [myarrow]  (vert4)  --  node[sloped, near start,above]{x:=x-1} (vert3);
\draw [myarrow]  (vert5)  -- node[sloped,above]{$x>y$}  (vert4);
\draw [myarrow]  (vert5)  -- node[sloped,above]{$!(x>y)$}  (vert7);
\draw [myarrow]  (vert3) |-  node[sloped, near start,above]{z:=y*y} (vert6);
\draw [myarrow]  (vert6)  |-  (vert5);
\draw [myarrow]  (vert8)  --  node[sloped, near start,above]{y:=3} (vert5);
