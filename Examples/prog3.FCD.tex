...
\matrix[row sep =5mm,column sep=5mm]{
 &\node(vert1)[start]{}; &\\
 &\node(vert10)[process]{sum:=0}; &\\
 &\node(vert9)[io]{ read z}; &\\
 &\node(vert6)[decision]{$z>0$}; &\\
 &\node(vert5)[process]{sum:=sum+sin(z)}; &\node(vert8)[point]{};\\
 &\node(vert4)[process]{z:=z-1}; &\\
\node(vert7)[point]{}; & &\\
 &\node(vert3)[io]{ print sum}; &\\
 &\node(vert2)[stop]{}; &\\
};
...
\draw [myarrow]  (vert6.south)  -| node[sloped,above, near start]{no}  (vert8.north);
