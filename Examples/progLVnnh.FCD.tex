...
\node(vert1)[start]{}; &\\
\node(vert9)[process]{x:=2}; &\\
\node(vert8)[process]{y:=4}; &\\
\node(vert7)[process]{x:=1}; &\\
\node(vert6)[decision]{$y>x$}; &\\
\node(vert5)[process]{z:=y}; &\node(vert4)[process]{z:=y*y};\\
\node(vert3)[process]{x:=z}; &\\
\node(vert2)[stop]{}; &\\
};
